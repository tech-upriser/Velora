  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-input:focus {
      ...
      background: #fff;
      box-shadow: 0 0 0 3px rgba(232,52,26,0.09);
    }
    ...
    .form-select option { background: #fff; color: #0d0d0d; }
...
export default function Profile() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const cu = auth.currentUser;
      if (!cu || !cu.email) throw new Error("No authenticated user found.");
                ...
                <div className="card-header">
                  <div className="card-title-wrap">
                    ...
                    <div>
                      ...
                      <div className="card-subtitle">Your current security status</div>
                    </div>
                  </div>
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Email Verified</div>
                    <div className="pref-desc">Your email address is confirmed</div>
                  </div>
                  <span className="verified-badge">✓ Verified</span>
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Two-Factor Authentication</div>
                    <div className="pref-desc">Add an extra layer of protection</div>
                  </div>
                  <Toggle value={prefs.twoFactor} onChange={v => handlePrefChange("twoFactor", v)} />
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Login Alerts</div>
                    <div className="pref-desc">Get notified of new sign-ins</div>
                  </div>
                  <Toggle value={prefs.loginAlerts} onChange={v => handlePrefChange("loginAlerts", v)} />
                </div>
              </div>
            ...
            <div className="profile-card">
              <div className="card-header">
                <div className="card-title-wrap">
                  ...
                  <div>
                    ...
                    <div className="card-subtitle">Your upcoming and past journeys</div>
                  </div>
                </div>
                <button className="edit-toggle-btn" onClick={() => navigate("/")}>
                  + Plan New Trip
                </button>
              </div>
              ...
              {sampleTrips.length === 0 ? (
                <div className="trips-empty">
                  ...
                  <div className="trips-empty-title">No trips yet</div>
                  <div className="trips-empty-desc">Start planning your next adventure and your trips will appear here.</div>
                </div>
              ) : (
                sampleTrips.map((trip, i) => (
                  <div key={i} className="trip-card">
                    <img src={trip.img} alt={trip.name} className="trip-thumb" />
                ...
                <div className="card-header">
                  <div className="card-title-wrap">
                    ...
                    <div>
                      ...
                      <div className="card-subtitle">Control what messages you receive</div>
                    </div>
                  </div>
                </div>
                <div className="pref-row">
                  <div>
                    ...
                    <div className="pref-desc">Booking confirmations and account alerts</div>
                  </div>
                  <Toggle value={prefs.emailNotifs} onChange={v => handlePrefChange("emailNotifs", v)} />
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Trip Reminders</div>
                    <div className="pref-desc">Reminders before your upcoming trips</div>
                  </div>
                  <Toggle value={prefs.tripReminders} onChange={v => handlePrefChange("tripReminders", v)} />
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Deals & Offers</div>
                    <div className="pref-desc">Exclusive travel deals and promotions</div>
                  </div>
                  <Toggle value={prefs.offers} onChange={v => handlePrefChange("offers", v)} />
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Newsletter</div>
                    <div className="pref-desc">Weekly travel inspiration and guides</div>
                  </div>
                  <Toggle value={prefs.newsletter} onChange={v => handlePrefChange("newsletter", v)} />
                </div>
              </div>
                ...
                <div className="card-header">
                  <div className="card-title-wrap">
                    ...
                    <div>
                      ...
                      <div className="card-subtitle">Manage your data and visibility</div>
                    </div>
                  </div>
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Public Profile</div>
                    <div className="pref-desc">Allow others to view your travel profile</div>
                  </div>
                  <Toggle value={prefs.publicProfile} onChange={v => handlePrefChange("publicProfile", v)} />
                </div>
                <div className="pref-row">
                  <div>
                    <div className="pref-label">Share Trip Data</div>
                    <div className="pref-desc">Help improve Velora with anonymous trip insights</div>
                  </div>
                  <Toggle value={prefs.shareData} onChange={v => handlePrefChange("shareData", v)} />
                </div>
              </div>
