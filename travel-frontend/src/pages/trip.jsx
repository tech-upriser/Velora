            ...
            <div className="btn-avatar-wrap" onClick={e => { e.stopPropagation(); setDropdownOpen(!dropdownOpen); }}>
              ...
              {dropdownOpen && (
                <div className="t-dropdown" onClick={e => e.stopPropagation()}>
                  ...
                  <button className="t-dropdown-item" onClick={() => { setDropdownOpen(false); navigate("/trips"); }}>
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M9 17H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2h-4M12 12v9M8 17l4 4 4-4"/>
                    </svg>
                    My Trips
                  </button>
                    ...
                    <div className="t-places-grid" style={{ marginBottom: 22 }}>
                      {places.map(place => (
                        <div key={place.name} className={`t-place-card ${selectedPlaces.includes(place.name) ? "selected" : ""}`}
                          ...
                          <img
                            src={place.photoUrl || getCityImg(searchCity)}
                            alt={place.name}
